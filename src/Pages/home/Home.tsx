   ...
   <div className="relative h-full ">
    <div className="  pb-20 object-cover h-full w-full ">
      ...
      <div className="flex flex-col gap-2  h-full text-white">
        ...
        {activeText === 'welcome' ? (
          <div className='z-10'>
     <h4 className="text-white z-10  text-[22px] leading-[40px] md:text-[28px] font-[400]">Welcome to <span className='text-amber-400'>Lazik Apartment!</span>
        <br /> We are excited to have you stay
        with us and hope you have a comfortable and enjoyable visit.
        <br />
        <br />
...
Throughout your stay, don't hesitate to reach out should you need anything.
<br/>
Our friendly staff members are available night or day to assist you.
<br/>
<br/>
To get to know more information about us
  ...
  <div onClick={() => setActiveText('welcome')} className='bg-amber-400 rounded-full  z-10 h-[4px] cursor-pointer w-[100px] md:w-[150px]'></div>
      <div onClick={() => setActiveText('another')} className='border border-amber-400 rounded-full cursor-pointer z-10 h-[4px] w-[100px] md:w-[150px]'></div>
          ...
          <div className='flex gap-3 pt-8'>
              <div onClick={() => setActiveText('welcome')} className='border border-amber-400 rounded-full cursor-pointer z-10 h-[4px] w-[100px] md:w-[150px]'></div>
          <div onClick={() => setActiveText('another')} className='bg-amber-400 rounded-full  z-10 h-[4px] cursor-pointer w-[100px] md:w-[150px]'></div>
